...
function createNewItem()
{
	...
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#type"),    RDF.GetLiteral("separator"), true); 
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#label"),   RDF.GetLiteral("------------------"), true); 
