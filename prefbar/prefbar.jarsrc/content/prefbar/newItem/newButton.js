...
function createNewItem()
{
	...
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#type"),    RDF.GetLiteral("button"), true); 
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#label"),   getItemLiteral("itemLabel"), true); 
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#onclick"), getItemLiteral("itemOnclick"), true); 
