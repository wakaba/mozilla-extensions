...
function setupEdit()
{
	...
	setField(itemId, "topref",     "itemToPref");
	setField(itemId, "frompref",   "itemFromPref");
}
...
function verifyData()
{
	...
	if(!attributeNotEmpty("topref",     "itemToPref"))     return false;
	if(!attributeNotEmpty("frompref",   "itemFromPref"))   return false;
...
function createNewItem()
{
	...
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#type"),       RDF.GetLiteral("check"),          true); 
	...
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#topref"),     getItemLiteral("itemToPref"),     true); 
	myDatasource.Assert(RitemId, RDF.GetResource("http://www.xulplanet.com/rdf/prefbar#frompref"),   getItemLiteral("itemFromPref"),   true); 
...
function editItem()
{
	...
	editField(itemId, "topref",     "itemToPref");
	editField(itemId, "frompref",   "itemFromPref");
}